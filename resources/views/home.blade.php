                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-9 col-md-10 col-sm-9">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">Laundry Sepatu Berkualitas</h1>
                                    <p data-animation="fadeInLeft" data-delay="0.4s">Kami siap merawat sepatu Anda</p>
                        ...
                        <div class="col-xl-12 ">
                            ...
                            <div class="testmonial-item-active text-center">
                                ...
                                <div class="testmonial-item ">
                                    <p class="pera">Pelayanan ramah, respon cepat, sepatu super duper bersih dan kinclong, thanks barokah LS!</p>
                                    <div class="rating">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-cap">
                                <span>1000+</span>
                                <p>Lebih dari seribu sepatu telah kami cuci dan bersihkan</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-cap">
                                <span>300+</span>
                                <p>Sudah lebih dari tiga ratus pelanggan mempercayakan sepatunya kepada kami</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-cap">
                                <span>98%</span>
                                <p>Pelanggan puas dengan hasil kerja kami</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <p class="mb-20">
                            Barokah laundry Shoes berdiri sejak tahun 2018 kami mengerjakan dengan sepenuh hati, agar customer happy
                            </p>
                            <p class="mb-30">Kepuasan anda adalah prioritas kami.  </p>
