...
<body>
    ...
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-9 col-md-10 col-sm-9">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">quality shoes laundry</h1>
                                    <p data-animation="fadeInLeft" data-delay="0.4s">We are ready to take care of your shoes</p>
                        ...
                        <div class="single-offers">
                            ...
                            <div class="offers-caption text-center">
                                ...
                                <div class="cat-cap">
                                    ...
                                    <p>Fast cleansing treatment with shoe material that is washed only the upper and midsole</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12 ">
                            ...
                            <div class="testmonial-item-active text-center">
                                ...
                                <div class="testmonial-item ">
                                    <p class="pera">Friendly service, fast response, super duper clean and shiny shoes, thanks for the blessing LS!</p>
                                    <div class="rating">
                                ...
                                <!-- testimonial-single-items -->
                                <div class="testmonial-item ">
                                    <p class="pera">Selalu puas karena cucinya bersih, kerjanya gercep, dan yang pasti harga pas dikantong!!! terimakasih!</p>
                                    <div class="rating">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                ...
                                <!-- testimonial-single-items -->
                                <div class="testmonial-item ">
                                    <p class="pera">great job!!! sepatu saya bener bener bersih! love barokah LS <3</p>
                                    <div class="rating">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-cap">
                                <span>1000+</span>
                                <p>We have washed and cleaned more than a thousand shoes</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-cap">
                                <span>300+</span>
                                <p>More than three hundred customers have entrusted their shoes to us</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-cap">
                                <span>98%</span>
                                <p>Customers are satisfied with our work</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <p class="mb-20">
                            Barokah Laundry Shoes was founded in 2018 we work with all our heart, so that customers are happy
                            </p>
                            <p class="mb-30">Your satisfaction is our priority.  </p>
        ...
        <div class="Map-area">
            <center>
            <img src="assets/img/gallery/peta.png" alt="" class="w-80">
            <center>
            <html>
               ...
               <div class="col-xl-12 ">
                   <div class="footer-copy-right text-center">
                       <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                          Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> love <a href="https://colorlib.com" target="_blank"></a>
